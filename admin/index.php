...
if (empty($_SESSION['user']) || $_SESSION['user']['role'] != 'admin_img') {
    header('Location: ../login/');
    exit;
}

$result = query("SELECT * FROM users_img");
?>
...
<head>
    ...
    <title>Admin obrazkova mapa</title>
...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <ul class="navbar-nav px-3">
        ...
        <li class="nav-item text-nowrap">
            ...
            <a class="nav-link" href="#" data-toggle="modal" data-target="#addNewUserModal">Přidat nového uživatele</a>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="addNewUserForm">
                            ...
                            <div class="form-group">
                                ...
                                <label for="addNewUserRole">Zvolte roli uživatele</label>

                                <select class="form-control" id="addNewUserRole" name="addNewUserRole">

                                    <option value="redaktor_img">Správce</option>

                                    <option value="admin_img">Administrátor</option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="confirmAddNewUser">Přidat nového uživatele</button>
                        </form>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Úprava uživatele</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="userEditForm">
                            ...
                            <div class="form-group">
                                ...
                                <label for="editUser">Nový login uživatele</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="editUserPassword">Nové heslo uživatele</label>
                            ...
                            <div class="form-group">
                                ...
                                <label for="editUserRole">Zvolte roli uživatele</label>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="confirmEdit">Upravit uživatele</button>
                        </form>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title">Odstranění uživatele</h5>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="../login/logout.php" type="button" class="btn btn-success">Ano, odhlaste se</a>
