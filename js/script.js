...
// choice map image
var bgUrl = '../img/map_img.jpg'; //editor page


// Система координат простая, поэтому указано просто разрешение
// изображения во втором массиве
...
tinymce.init({
    selector: '#mytextarea',
    plugins: 'advlist autolink lists link paste charmap insertdatetime media imagetools wordcount image hr lists charmap preview autoresize',
    branding: false,
