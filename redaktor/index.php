...
if (empty($_SESSION['user']) || $_SESSION['user']['role'] != 'redaktor_img') {
...
<head>
    ...
    <title>Správce obrázkové mapy</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="alert alert-success" role="alert" id="editUserAlertSuccessRedaktor" style="display: none"></div>
                        ...
                        <button class="btn btn-primary" id="save" type="submit" form="tiny-form">Uložit změny</button>
                    </div>
                </div>
            </div>
        </div>
