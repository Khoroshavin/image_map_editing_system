...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM users_img WHERE log = '$username'";
...
<head>
    ...
    <title>Login leaflet img map</title>
    <!-- Bootstrap CSS -->
...
<div class="container signin__container">
    ...
    <form class="form__signin" method="post" class="form">
        ...
        <h1 class="h3 mb-3 font-weight-normal d-flex justify-content-center">Obrázková mapa</h1>
